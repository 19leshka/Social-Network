...
const Chat = (props) => {
    ...
    let messages = [...props.dialogMessages]
                        .map((message) => {
                            if(message.author == 0){
                                return <MessageItemAuthor key={message.id} text={message.text}/>
                            }else if(message.author == 1){
                                return <MessageItemCompanion key={message.id} text={message.text}/>
                            }
                        })
        ...
        <div className={s.chat}>
            ...
            <div className={s.createMessage}>
                <div className={s.message}>
                    <input className={s.messageInput} onChange={onUpdateMessageText} ref={textarea} type="text" placeholder="Write a message..." value={props.newMessageText} />
                </div>
                <div className={s.sendMessageBtn} onClick={onSendMessage}>
